...
class UserLogin(MethodView):
    ...
    def post(self, user_data):
        """API for authetication of the provided email and password"""
...
class TokenRefresh(MethodView):
    ...
    def post(self):
        """API for sending a new access token to the user when the previous one expires"""
...
class SendEmail(MethodView):
    ...
    @jwt_required()
    def post(self):
        """API that sends email to the pet's owner"""
