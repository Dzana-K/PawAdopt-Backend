...
class AnimalsAPI(MethodView):
    ...
    def get(self):
        ...
        """API for fetching the list of animals up for adoption"""
    ...
    def post(self):
        """API for posting animal up for adoption and adding it to animals table"""
...
class FetchAnimal(MethodView):
    ...
    def get(self, animal_id):
        """API for fetching a specific animal's data from the animals table"""
...
class PhotoAPI(MethodView):
    ...
    def get(self, animal_id, filename):
        """Constructs path for a specific photo"""
...
class UserPosts(MethodView):
    ...
    @blp.response(200, AnimalSchema(many=True))
    def get(self):
        """API for fetching all of user's posts from animals table"""
        user_id = get_jwt_identity()
